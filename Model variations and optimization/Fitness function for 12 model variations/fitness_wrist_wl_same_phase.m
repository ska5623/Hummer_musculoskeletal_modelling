function y = fitness_wrist_wl_same_phase(paramu)
...
%pect and supr
 [Fcpgpos, Fcpgneg] = CPGforce_no_comp(s1,s2,phi,0.5);
      %deviation
 [Fcpgposd, Fcpgnegd] = CPGforce(s1d,s2d,pshiftd,sshiftd,phi,0.5);
      %pitch
 [Fcpgposp, Fcpgnegp] = CPGforce(s1p,s2p,pshiftp,sshiftp,phi,0);
